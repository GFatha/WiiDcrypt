...
MESSAGES = {
    ...
    "selected_folder": "Selected folder: {selected_path}",
    "extracted_title_id": "📦 Extracted Title ID: {title_id}",
    "game_info": "🎮 Game Name: {matched_name}\n🆔 Title ID: {matched_title_id}\n🔐 Title Key: {matched_title_key}",
    "match_failed": "No match found for Title ID: {title_id}",
    "use_title_tmd": "A title.tmd file was found.\nWould you like to use it?",
}
